...
type V1GetRoomResponse struct {
	...
	UserStatus string `protobuf:"bytes,5,opt,name=userStatus,proto3" json:"userStatus,omitempty"`
}
...
func (x *V1GetRoomResponse) GetUserID() int32 {
	if x != nil {
		return x.UserID
	}
	return 0
...
func (x *V1GetRoomResponse) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *V1GetRoomResponse) GetUserAvatar() string {
	if x != nil {
		return x.UserAvatar
	}
	return ""
...
func (x *V1GetRoomResponse) GetUserStatus() string {
	if x != nil {
		return x.UserStatus
	}
	return ""
...
var file_proto_message_service_response_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x22, 0x9f, 0x01, 0x0a, 0x11, 0x56, 0x31, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x6f,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x40, 0x0a, 0x14, 0x56, 0x31, 0x41, 0x64, 0x64, 0x4d, 0x65,
	...
	0x6f, 0x67, 0x65, 0x6e, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2d, 0x73, 0x65, 0x72,
...
var file_proto_message_service_response_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_message_service_response_proto_goTypes = []interface{}{
	...
	(*RoomMember)(nil),                // 5: proto.RoomMember
	(*Message)(nil),                   // 6: proto.Message
}
var file_proto_message_service_response_proto_depIdxs = []int32{
	5, // 0: proto.V1AddMemberToRoomResponse.members:type_name -> proto.RoomMember
	6, // 1: proto.V1AddMessageResponse.message:type_name -> proto.Message
	6, // 2: proto.V1GetRoomMessagesResponse.messages:type_name -> proto.Message
