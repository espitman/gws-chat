...
var file_proto_message_service_response_proto_goTypes = []interface{}{
	...
	(*MessageUser)(nil),               // 6: proto.MessageUser
...
var file_proto_message_service_response_proto_depIdxs = []int32{
	...
	6, // 1: proto.V1GetRoomResponse.user:type_name -> proto.MessageUser
	6, // 2: proto.V1GetRoomResponse.audience:type_name -> proto.MessageUser
	7, // 3: proto.V1GetRoomResponse.messages:type_name -> proto.Message
	7, // 4: proto.V1AddMessageResponse.message:type_name -> proto.Message
	7, // 5: proto.V1GetRoomMessagesResponse.messages:type_name -> proto.Message
