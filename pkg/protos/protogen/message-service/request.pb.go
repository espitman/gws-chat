...
type V1GetUserChatsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *V1GetUserChatsRequest) Reset() {
	*x = V1GetUserChatsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_message_service_request_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *V1GetUserChatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*V1GetUserChatsRequest) ProtoMessage() {}

func (x *V1GetUserChatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_message_service_request_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use V1GetUserChatsRequest.ProtoReflect.Descriptor instead.
func (*V1GetUserChatsRequest) Descriptor() ([]byte, []int) {
	return file_proto_message_service_request_proto_rawDescGZIP(), []int{5}
}

type V1GetAudienceIDRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *V1GetAudienceIDRequest) Reset() {
	*x = V1GetAudienceIDRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_message_service_request_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *V1GetAudienceIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*V1GetAudienceIDRequest) ProtoMessage() {}

func (x *V1GetAudienceIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_message_service_request_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use V1GetAudienceIDRequest.ProtoReflect.Descriptor instead.
func (*V1GetAudienceIDRequest) Descriptor() ([]byte, []int) {
	return file_proto_message_service_request_proto_rawDescGZIP(), []int{6}
}

func (x *V1GetAudienceIDRequest) GetRoomID() string {
	if x != nil {
		return x.RoomID
	}
	return ""
...
var file_proto_message_service_request_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x44, 0x22, 0x17,
	0x0a, 0x15, 0x56, 0x31, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x61, 0x74, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x30, 0x0a, 0x16, 0x56, 0x31, 0x47, 0x65, 0x74,
	0x41, 0x75, 0x64, 0x69, 0x65, 0x6e, 0x63, 0x65, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x44, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69, 0x74,
...
var file_proto_message_service_request_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
func file_proto_message_service_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_message_service_request_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*V1GetUserChatsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_message_service_request_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*V1GetAudienceIDRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
