...
type V1CreateRoomRequest struct {
	...
	Userid1 int32 `protobuf:"varint,1,opt,name=userid1,proto3" json:"userid1,omitempty"`
	Userid2 int32 `protobuf:"varint,2,opt,name=userid2,proto3" json:"userid2,omitempty"`
}
...
func (x *V1CreateRoomRequest) GetUserid1() int32 {
	if x != nil {
		return x.Userid1
	}
	return 0
...
func (x *V1CreateRoomRequest) GetUserid2() int32 {
	if x != nil {
		return x.Userid2
	}
	return 0
...
var file_proto_message_service_request_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x49, 0x0a, 0x13,
	0x56, 0x31, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6f, 0x6d, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x69, 0x64, 0x31, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x69, 0x64, 0x31, 0x12, 0x18, 0x0a,
	0x07, 0x75, 0x73, 0x65, 0x72, 0x69, 0x64, 0x32, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07,
	0x75, 0x73, 0x65, 0x72, 0x69, 0x64, 0x32, 0x42, 0x42, 0x5a, 0x40, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_proto_message_service_request_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
