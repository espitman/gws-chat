...
var file_proto_message_service_service_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xf7, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73,
...
var file_proto_message_service_service_proto_goTypes = []interface{}{
	...
	(*V1CreateRoomResponse)(nil),      // 3: proto.V1CreateRoomResponse
	(*V1AddMemberToRoomResponse)(nil), // 4: proto.V1AddMemberToRoomResponse
	(*V1GetRoomResponse)(nil),         // 5: proto.V1GetRoomResponse
}
var file_proto_message_service_service_proto_depIdxs = []int32{
	...
	3, // 3: proto.MessageService.V1CreateRoom:output_type -> proto.V1CreateRoomResponse
	4, // 4: proto.MessageService.V1AddMemberToRoom:output_type -> proto.V1AddMemberToRoomResponse
	5, // 5: proto.MessageService.V1GetRoom:output_type -> proto.V1GetRoomResponse
