...
var file_proto_message_service_service_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xed, 0x03, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73,
...
var file_proto_message_service_service_proto_goTypes = []interface{}{
	...
	(*V1CreateRoomResponse)(nil),      // 6: proto.V1CreateRoomResponse
	(*V1AddMemberToRoomResponse)(nil), // 7: proto.V1AddMemberToRoomResponse
	(*V1GetRoomResponse)(nil),         // 8: proto.V1GetRoomResponse
	(*V1AddMessageResponse)(nil),      // 9: proto.V1AddMessageResponse
	(*V1GetRoomMessagesResponse)(nil), // 10: proto.V1GetRoomMessagesResponse
	(*V1GetUserChatsResponse)(nil),    // 11: proto.V1GetUserChatsResponse
}
var file_proto_message_service_service_proto_depIdxs = []int32{
	...
	6,  // 6: proto.MessageService.V1CreateRoom:output_type -> proto.V1CreateRoomResponse
	7,  // 7: proto.MessageService.V1AddMemberToRoom:output_type -> proto.V1AddMemberToRoomResponse
	8,  // 8: proto.MessageService.V1GetRoom:output_type -> proto.V1GetRoomResponse
	9,  // 9: proto.MessageService.V1AddMessage:output_type -> proto.V1AddMessageResponse
	10, // 10: proto.MessageService.V1GetRoomMessages:output_type -> proto.V1GetRoomMessagesResponse
	11, // 11: proto.MessageService.V1GetUserChats:output_type -> proto.V1GetUserChatsResponse
