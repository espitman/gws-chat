...
var file_proto_message_service_service_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb5, 0x01, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73,
	...
	0x42, 0x5a, 0x40, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x73,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2d, 0x73, 0x65, 0x72, 0x76,
...
var file_proto_message_service_service_proto_goTypes = []interface{}{
	...
	(*V1CreateRoomResponse)(nil),      // 2: proto.V1CreateRoomResponse
	(*V1AddMemberToRoomResponse)(nil), // 3: proto.V1AddMemberToRoomResponse
}
var file_proto_message_service_service_proto_depIdxs = []int32{
	...
	2, // 2: proto.MessageService.V1CreateRoom:output_type -> proto.V1CreateRoomResponse
	3, // 3: proto.MessageService.V1AddMemberToRoom:output_type -> proto.V1AddMemberToRoomResponse
