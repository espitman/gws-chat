...
var file_proto_message_service_service_proto_rawDesc = []byte{
	...
	0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x9c, 0x03, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73,
	...
	0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x67, 0x65, 0x6e, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_proto_message_service_service_proto_goTypes = []interface{}{
	...
	(*V1CreateRoomResponse)(nil),      // 5: proto.V1CreateRoomResponse
	(*V1AddMemberToRoomResponse)(nil), // 6: proto.V1AddMemberToRoomResponse
	(*V1GetRoomResponse)(nil),         // 7: proto.V1GetRoomResponse
	(*V1AddMessageResponse)(nil),      // 8: proto.V1AddMessageResponse
	(*V1GetRoomMessagesResponse)(nil), // 9: proto.V1GetRoomMessagesResponse
}
var file_proto_message_service_service_proto_depIdxs = []int32{
	...
	5, // 5: proto.MessageService.V1CreateRoom:output_type -> proto.V1CreateRoomResponse
	6, // 6: proto.MessageService.V1AddMemberToRoom:output_type -> proto.V1AddMemberToRoomResponse
	7, // 7: proto.MessageService.V1GetRoom:output_type -> proto.V1GetRoomResponse
	8, // 8: proto.MessageService.V1AddMessage:output_type -> proto.V1AddMessageResponse
	9, // 9: proto.MessageService.V1GetRoomMessages:output_type -> proto.V1GetRoomMessagesResponse
